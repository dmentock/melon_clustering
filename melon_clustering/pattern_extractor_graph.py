...
class PatternExtractorGraph:
    ...
    def compute_weighted_sentence_embedding(self, sentence_path, weighting_scheme = None, steepness = 1):
        """
    ...
    def generate_sentence_embeddings(self, sentences_dict, steepness=None):
        """
    ...
    def initialize(self, sentences_dict, overlap_threshold=0.6):
        self.create_tree_mask_as_root(sentences_dict)
        self.optimize_tree('<ROOT>', 'preceding', overlap_threshold=overlap_threshold)
        self.optimize_tree('<ROOT>', 'following', overlap_threshold=overlap_threshold)